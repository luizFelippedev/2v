  ...
  const [certificates] = useState<Certificate[]>([
    {
      ...
      description:
        "Certificação que valida conhecimentos técnicos para projetar e implementar sistemas distribuídos escaláveis, altamente disponíveis e tolerantes a falhas na AWS.",
      skills: [
        "AWS",
        "Cloud Architecture",
        "S3",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/300",
      description:
        "Especialização completa em desenvolvimento mobile com React Native, cobrindo desde conceitos básicos até técnicas avançadas de otimização e deployment.",
      skills: [
        "React Native",
        "Mobile Development",
        "JavaScript",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/300",
      description:
        "Certificação que demonstra proficiência em usar TensorFlow para resolver problemas de machine learning e deep learning em diferentes domínios.",
      skills: [
        "TensorFlow",
        "Machine Learning",
        "Python",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/300",
      description:
        "Certificação que valida habilidades para projetar, construir e evoluir aplicações usando MongoDB como banco de dados.",
      skills: [
        "MongoDB",
        "NoSQL",
        "Database Design",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/300",
      description:
        "Certificação que demonstra competência em containerização, orchestração e gerenciamento de aplicações Docker em ambientes de produção.",
      skills: [
        "Docker",
        "Containerization",
        "Docker Compose",
    ...
    },
    {
      ...
      image: "/api/placeholder/400/300",
      description:
        "Certificação em metodologia ágil Scrum, focando em liderança de equipes, facilitação de cerimônias e remoção de impedimentos.",
      skills: [
        "Scrum",
        "Agile",
        "Project Management",
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Minhas certificações profissionais que validam expertise e
              compromisso com a excelência técnica e aprendizado contínuo.
            </p>
                ...
                >
                  ...
                  >
                    ...
                    <div className="absolute top-4 right-4">
                      <div
                        className={`px-2 py-1 border rounded-full text-xs font-medium capitalize ${getLevelColor(
                          cert.level,
                        )}`}
                      >
                        {cert.level}
                  ...
                  <div className="p-6 flex-1">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      {cert.expiryDate && (
                        <div
                          className={`text-xs ${getExpirationStatus(
                            cert.expiryDate,
                          )?.color}`}
                        >
                    ...
                    <div className="space-y-2 text-xs text-gray-400">
                      ...
                      {cert.examScore && (
                        <div className="flex items-center justify-between">
                          <span>Pontuação:</span>
                          <span>
                            {cert.examScore}/{cert.passingScore}
                          </span>
                        </div>
                      )}
                      {cert.courseHours && (
