  ...
  const mockProjects: LocalProject[] = useMemo(
    () => [
      ...
      },
      {
        ...
        shortDescription:
          "Dashboard administrativo para gerenciamento de portfolio com analytics",
        category: "web_app",
        technologies: [
      ...
      },
      {
        ...
        shortDescription:
          "Sistema de votação descentralizado usando Ethereum e Solidity",
        category: "blockchain",
        technologies: [
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              modernas até soluções de IA inovadoras. Cada projeto representa um
              desafio único e uma oportunidade de crescimento.
            </p>
          </motion.div>
                  ...
                  <div
                    className={
                      viewMode === "grid"
                        ...
                        : "relative overflow-hidden w-64 flex-shrink-0"
                    }
                  >
                    <img
