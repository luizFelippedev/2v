  ...
  const timeline = [
    {
      ...
      description:
        "Liderando desenvolvimento de aplicações enterprise com foco em IA e automação.",
      type: "work",
    },
    {
      year: "2023",
    ...
    },
    {
      ...
      company: "StartupTech",
      description:
        "Desenvolvimento de plataforma SaaS para gestão empresarial com 100k+ usuários.",
      type: "work",
    },
    {
      year: "2021",
      ...
      company: "Unesa",
      description:
        "Graduação com foco em Inteligência Artificial e Engenharia de Software.",
      type: "education",
    },
    {
      year: "2020",
      ...
      description:
        "Início da carreira profissional desenvolvendo aplicações web com React e Node.js.",
      type: "work",
    },
  ];
  ...
  const interests = [
    {
      icon: <Code2 />,
      name: "Coding",
      description: "Apaixonado por criar soluções elegantes",
    },
    {
      icon: <GlassWater />,
      name: "Coke",
      description: "Combustível para longas sessões de código",
    },
    {
      icon: <BookOpen />,
      name: "Learning",
      description: "Sempre aprendendo novas tecnologias",
    },
    {
      icon: <Heart />,
      name: "Open Source",
      description: "Contribuindo para a comunidade",
    },
  ];
          ...
          >
            ...
            <div className="text-lg text-gray-300 leading-relaxed space-y-4">
              <p>
                ...
                experiências digitais excepcionais. Com mais de 5 anos de
                experiência, especializo-me em React, Node.js e tecnologias de
                IA.
              </p>
              <p>
                Minha jornada começou com curiosidade sobre como as coisas
                funcionam digitalmente. Hoje, transformo ideias complexas em
                soluções elegantes e escaláveis, sempre focando na experiência
                do usuário e na performance.
              </p>
              <p>
                Quando não estou codificando, você me encontrará explorando
