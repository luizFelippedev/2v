  ...
  const skills: Skill[] = [
    {
      ...
      projects: 25,
      description:
        "Framework principal para desenvolvimento frontend, incluindo hooks avançados e otimizações.",
    },
    {
      id: "2",
      name: "Node.js",
      ...
      projects: 20,
      description:
        "Runtime JavaScript para backend, APIs RESTful e microserviços escaláveis.",
    },
    {
      id: "3",
      name: "TypeScript",
      ...
      projects: 22,
      description:
        "Superset do JavaScript para desenvolvimento type-safe e mais produtivo.",
    },
    {
      id: "4",
      name: "Python",
      ...
      projects: 15,
      description:
        "Linguagem versátil para backend, automação e machine learning.",
    },
    {
      id: "5",
      name: "React Native",
      ...
      projects: 8,
      description:
        "Framework para desenvolvimento mobile cross-platform iOS e Android.",
    },
    {
      id: "6",
      name: "Docker",
      ...
      projects: 18,
      description:
        "Containerização de aplicações para deployment consistente e escalável.",
    },
    {
      id: "7",
      name: "PostgreSQL",
      ...
      projects: 16,
      description:
        "Banco de dados relacional avançado para aplicações enterprise.",
    },
    {
      id: "8",
      name: "TensorFlow",
      ...
      projects: 6,
      description:
        "Framework de machine learning para desenvolvimento de modelos de IA.",
    },
    {
      id: "9",
      name: "Figma",
      ...
      projects: 12,
      description:
        "Ferramenta de design para criação de interfaces e protótipos interativos.",
    },
  ];
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 leading-relaxed">
              Um overview completo das minhas habilidades técnicas e
              certificações profissionais. Sempre aprendendo e evoluindo com as
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Tecnologias que domino e utilizo no dia a dia para criar soluções
              inovadoras
            </p>
          </motion.div>
          ...
          >
            <div className="flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="flex items-center space-x-4">
                ...
                >
                  <option value="level" className="bg-gray-800">
                    Nível
                  </option>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              Certificações que validam minha expertise e compromisso com o
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="absolute top-4 right-4">
                    <div
                      className={`px-2 py-1 rounded-full text-xs font-medium capitalize ${getCertificateLevelColor(
                        cert.level,
                      )}`}
                    >
                      {cert.level}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-gray-300 text-lg mb-8">
              A tecnologia evolui rapidamente, e eu acompanho essa evolução
              através de aprendizado contínuo e certificações atualizadas.
            </p>
